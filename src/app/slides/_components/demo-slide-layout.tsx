...
function AgentVerbMappingRow({
  ...
  return (
    <div className="flex min-h-[56px] items-center gap-5">
      <span
        className={`inline-flex shrink-0 items-center rounded-full border px-5 py-2.5 font-mono text-xl font-semibold leading-none tracking-tight ${VERB_MAPPING_TONE_CLASS[mapping.tone]}`}
      >
        {mapping.label}
      </span>
