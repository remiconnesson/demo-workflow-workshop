...
export const SLIDES: SlideInfo[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "",
      "TRANSITION: Press d → turn OFF auto-ack. Run an order. Accept restaurant manually, then click Driver: decline. Watch releaseDriver, cancelRestaurantOrder, then refundPayment appear in the fuchsia section. Then return.",
    ].join("\n"),
  },
  ...
  // ─── ACT 9: "Go build" ───────────────────────────────────────
  {
    ...
    notes: [
      ...
      "",
      "SAY: \"The Workflow Development Kit is GA. Vercel Workflow is the managed platform built on top of it.\"",
      "NOTE: Check with product before the talk — if managed Workflow is also GA by then, simplify to: \"Workflow is GA tonight. Start at vercel.com/docs/workflow.\"",
      "",
      "PAUSE for applause.",
      "",
