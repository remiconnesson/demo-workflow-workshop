  ...
  return (
    <div className="mx-auto grid h-full w-full max-w-[1580px] content-center gap-8 px-14 py-16">
      ...
      <div className="grid min-h-0 grid-cols-[minmax(0,1fr)_430px] items-stretch gap-8">
        <div
          className={`rounded-2xl border border-white/10 bg-zinc-950 p-10 ${SETUP_RISK_HIGHLIGHT_CLASS}`}
        >
          <CodeBlock
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <p
                      className={`font-mono text-2xl font-semibold uppercase tracking-[0.18em] ${tone.label}`}
                    >
                      {group.verb}
                    </p>
                  </div>
